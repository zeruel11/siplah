...
CREATE TABLE `gedung` (
  ...
  `kategoriGedung` int(11) NOT NULL,
  ...
  KEY `fk_kategoriGedung` (`kategoriGedung`),
  CONSTRAINT `gedung_ibfk_1` FOREIGN KEY (`kategoriGedung`) REFERENCES `kategori` (`idKategori`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'zeruel','ca9820427073d97200124dae537ff784',1,'w sakti');
...
-- Dump completed on 2017-11-29 10:33:43
