...
CREATE TABLE `pekerjaan` (
  ...
  `judulPekerjaan` varchar(255) NOT NULL,
  `deskripsiPekerjaan` varchar(500) DEFAULT NULL,
  ...
  FULLTEXT KEY `ft_deskripsiPekerjaan` (`deskripsiPekerjaan`),
  CONSTRAINT `pekerjaan_ibfk_1` FOREIGN KEY (`idGedung`) REFERENCES `gedung` (`idGedung`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-16 12:15:07
