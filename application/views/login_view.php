		...
		<form class="form-horizontal mx-auto" role="form" method="POST" action="<?php echo base_url().'index.php/ver_login'; ?>">
			...
			<div class="form-control-feedback">
				<span class="text-danger align-middle">
					...
					<?php if ($validLogin) { ?>
					<i class="fa fa-close"></i> Username atau password Anda<br>salah, harap coba kembali
					<?php } ?>
				</span>
			</div>
			<div class="row">
				...
				<div class="form-group has-danger">
					...
					<div class="input-group">
						...
						<input type="text" name="username" class="form-control" id="username" placeholder="Username" required autofocus oninvalid="this.setCustomValidity('Masukkan username')" oninput="setCustomValidity('')" />
					</div>
				</div>
				<!-- </div> -->
			</div>
